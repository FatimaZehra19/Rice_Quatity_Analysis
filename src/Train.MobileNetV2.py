...
print("="*70)
print("MOBILENET_V2 TRANSFER LEARNING - RICE CLASSIFICATION")
print("="*70)
print("\n📊 HYPERPARAMETERS:")
print(f"  • Seed: {SEED}")
...
print("🔄 Loading pretrained MobileNet_V2 (ImageNet weights)...")
model = models.mobilenet_v2(weights=models.MobileNet_V2_Weights.IMAGENET1K_V1)
print("✓ Loaded pretrained MobileNet_V2")
...
# Replace the final classifier for rice classes
print(f"\n🎯 Replacing final classifier with custom head for {NUM_CLASSES} rice classes...")
# MobileNetV2 uses model.classifier[1] as the linear layer
# We replace the whole classifier sequence
...
# In MobileNetV2, we optimize the classifier parameters
...
history_path = experiments_dir / f"training_history_mobilenetv2_transfer_{timestamp}.json"
...
print("\n💾 SAVED:")
print("-" * 70)
print(f"  • Model: rice_mobilenetv2_transfer_best.pth")
print(f"  • History: training_history_mobilenetv2_transfer_{timestamp}.json")
print("="*70)
