...
# Replace the final fully connected layer (same as training)
...
report_path = results_dir / "classification_report_resnet50_model.txt"
...
print("="*70)
print("\n💾 Saved Results:")
print(f"  • Confusion Matrix: confusion_matrix_resnet50_model.png")
print(f"  • Classification Report: classification_report_resnet50_model.txt")
print("="*70)
